...
/*   Updated: 2022/08/28 23:41:43 by gbierny          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    *check_death(void *phi)
{
    ...
    while (1)
    {
        ...
        // printf("\t\tresting time de la mort: %d et le temps: %d\n", philo.resting_time - philo.state->start, get_time() - philo.state->start);
